...
<Steps>
  ...
  <Step title="Create GitHub App">
    ...
    **Account permissions:** None
    ...
    - **GITHUB_APP_REDIRECT_URI**: Should be `http://localhost:3001/api/auth/github/callback` for local development, or `https://your-production-url.com/api/auth/github/callback` for production.
  ...
  <Step title="Start Development Servers">
    ...
    **Terminal 1 - Start the LangGraph Agent:**
    ...
    yarn dev
    ```
    This starts the LangGraph server at `http://localhost:2025`
    ...
    **Terminal 2 - Start the Web Application:**
    ...
    yarn dev
    ```
    This starts the Next.js web app at `http://localhost:3001`
...
1. **Visit the web app**: Navigate to `http://localhost:3001`
